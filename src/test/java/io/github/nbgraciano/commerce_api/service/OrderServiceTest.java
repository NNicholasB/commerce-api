...
public class OrderServiceTest {
    ...
    void erroShip(){
        UUID orderId= UUID.randomUUID();
        when(repository.findById(orderId)).thenReturn(Optional.empty());
        EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> service.ship(orderId));
    ...
    void erroDeliver(){
        UUID orderId= UUID.randomUUID();
        when(repository.findById(orderId)).thenReturn(Optional.empty());
        EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> service.deliver(orderId));
    ...
    void ErroDeliverStatus(){
        ...
        BusinessException ex = assertThrows(BusinessException.class, () -> service.deliver(orderId));
